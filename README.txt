BCIT 2537 WebDev 2 course Assignment 1 - node.js, express, Encrypted sessions, MongoDB, User Authentication, 
NoSQL injection attacks, .env files, git repos, BCrypt passwords, and hosted on Render.
